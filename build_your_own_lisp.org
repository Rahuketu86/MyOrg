...
* Code
  ...
  - Compiler
    - Clang and/or gcc for linux
      ...
      #+begin_src sh :results verbatim :exports both -n
        gcc --version
      #+end_src
    ...
    - mingw-gcc and wine for windows
      ...
      #+begin_src sh n:results verbatim :exports both -n
...
** Baby First Steps
   ...
   #+begin_src C :tangle byol/hello_world.c :results verbatim :exports both -n
     #include <stdio.h>

     int main(int argc, char** argv){
       puts("Hello, World from Org and C language!");
       return 0;
     }
   #+end_src 

   #+RESULTS:
   : Hello, World from Org and C language!
